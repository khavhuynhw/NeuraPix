  ...
  return (
    <MainWrapper>
      <CenteredContainer>
        ...
        <FormCol>
          <StyledCard>
            <Title level={3} style={{ textAlign: 'center', marginBottom: 24, fontWeight: 700 }}>Create Your Account</Title>
            <Form
              form={form}
              name="register"
              onFinish={onFinish}
            ...
            >
              ...
              <div style={{ textAlign: 'center', marginTop: 12 }}>
                ...
                <a onClick={handleLoginRedirect} style={{ color: '#0079ff', fontWeight: 500, cursor: 'pointer' }}>
                  Login here
                </a>
              </div>
            </Form>
